# NSDERungeKutta/src/dirk/solvers.jl
...
"""
function BackwardEuler(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 1
...
"""
function ImplicitMidpoint(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 2
    tableau = ButcherTableau(float([
        1/2 1/2;
          p   1;
...
"""
    SDIRK2(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10) :: DiagonallyImplicitRungeKuttaSolver

returns an [`DiagonallyImplicitRungeKuttaSolver`](@ref) for the 2nd-order SDIRK method.
"""
function SDIRK2(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 2
    tableau = ButcherTableau(float([
        1   1   0;
        0  -1   1;
...
"""
    LobattoIII2(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10) :: DiagonallyImplicitRungeKuttaSolver

returns an [`DiagonallyImplicitRungeKuttaSolver`](@ref) for the 2nd-order Lobatto III method.
"""
function LobattoIII2(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 2
    tableau = ButcherTableau(float([
        0   0   0;
        1   1   0;
...
"""
function CrankNicolson(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 2
    tableau = ButcherTableau(float([
        0   0   0;
        1 1/2 1/2;
...
"""
    SDIRK3(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10) :: DiagonallyImplicitRungeKuttaSolver

returns an [`DiagonallyImplicitRungeKuttaSolver`](@ref) for the 3rd-order SDIRK method.
"""
function SDIRK3(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 3
    γ = 1/2 + √3/6
    tableau = ButcherTableau(float([
          γ    γ   0;
...
"""
    RadauI3(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10) :: DiagonallyImplicitRungeKuttaSolver

returns an [`DiagonallyImplicitRungeKuttaSolver`](@ref) for the 3rd-order Radau I method.
"""
function RadauI3(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 3
    tableau = ButcherTableau(float([
         0   0   0;
       2/3 1/3 1/3;
...
"""
    RadauII3(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10) :: DiagonallyImplicitRungeKuttaSolver

returns an [`DiagonallyImplicitRungeKuttaSolver`](@ref) for the 3rd-order Radau II method.
"""
function RadauII3(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 3
    tableau = ButcherTableau(float([
       1/3 1/3   0;
         1   1   0;
...
"""
    SDIRK4(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10) :: DiagonallyImplicitRungeKuttaSolver

returns an [`DiagonallyImplicitRungeKuttaSolver`](@ref) for the 4th-order SDIRK method.
"""
function SDIRK4(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 4
    tableau = ButcherTableau(float([
          1/4      1/4         0      0      0   0;
          3/4      1/2       1/4      0      0   0;
...
"""
    LobattoIII4(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10) :: DiagonallyImplicitRungeKuttaSolver

returns an [`DiagonallyImplicitRungeKuttaSolver`](@ref) for the 4th-order Lobatto III method.
"""
function LobattoIII4(; h::Real=0.0, εᵣ::Real=1e-8, εₐ::Real=1e-12, Mₙ::Integer=10)
    p = 4
    tableau = ButcherTableau(float([
          0   0   0   0;
        1/2 1/4 1/4   0;
